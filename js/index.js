...
(function() {
    var yearData = [{
            ...
            data: [
                ...
                [40, 64, 123, 324, 290, 330, 310, 213, 180, 200, 180, 79],
    ...
    var option = {
        // 通过这个color修改两条线的颜色
        color: ["#00f2f1", "#ed3f35","#00f2f1", "#ed3f35"],
        tooltip: {
            trigger: "axis",
        },
        // 图列组件
    ...
    option = {
        ...
        series: [{
            ...
            data: [
                { value: 20, name: "软件维护" },
                { value: 26, name: "物业安保" },
                { value: 24, name: "员工福利薪水" },
                { value: 25, name: "员工职业教育" },
                { value: 20, name: "场地租金" },
                { value: 25, name: "专家讲座" },
                { value: 30, name: "食宿费用" },
                { value: 42, name: "仪器引进" },
    ...
    series: [
        {
            ...
            detail: {
                backgroundColor: 'rgba(24,150,102,0.8)',
                borderWidth: 1,
                borderColor: '#000000',
                shadowColor: '#fff', //默认透明
                shadowBlur: 5,
